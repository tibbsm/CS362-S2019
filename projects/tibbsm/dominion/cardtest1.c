...
int main(int argc, char const *argv[])
{
    ...
    printf("[ TESTING: Adventurer Card - Part Two ]\n");
    ...
    // Adventurer should not alter the numPlayers variable of the gamestate.
    ...
    // Adventurer should not alter the outpostPlayed variable of the gamestate.
    ...
    // Adventurer should not alter the outpostTurn variable of the gamestate.
    ...
    // Adventurer should not alter the whoseTurn variable of the gamestate.
    ...
    // Adventurer should not alter the phase variable of the gamestate.
    ...
    // Adventurer should not alter the numActions variable of the gamestate.
    ...
    // Adventurer should not alter the numBuys variable of the gamestate.
    ...
    // Adventurer should not alter the original cards in the players hand.
    ...
    // Adventurer should be the last card added to playedCards.
    printf("(Test 10) Checking playedCards variable: ");  
    if (tester.playedCards[tester.playedCardCount - 1] == adventurer)
    {   
        fails++;
        total++;
        printf("FAILED\n");
